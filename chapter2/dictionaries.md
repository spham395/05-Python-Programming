...
Create a program that takes input of a group of students' names and grades... then sorts them based on highest to lowest grade.  Then calculate and print the average for the class. \(Hint: Use Dictionaries!\)
